import { PolicyId, TokenAddress, TokenName } from '@/types/token'
...
export function toTokenAddress(arg0: string, arg1: TokenName | undefined = undefined, isHex = true): TokenAddress {
...
export function equalsAddress(a: TokenAddress, b: TokenAddress): boolean {
  return a != null && b != null && a.policyId === b.policyId && a.name === b.name
}
