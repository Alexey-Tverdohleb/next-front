...
import { IProps } from '@/app/[locale]/my-trades/_components/StatusModal/types';
import Modal from '@/components/Modal';
import Card from '@/app/[locale]/minting/_components/Card';

const StatusModal: FC<IProps> = ({ isShow, toggleShow, handleConfirm }) => {
  const t = useTranslations('MyTradesPage.confirmModal');
